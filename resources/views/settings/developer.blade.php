<x-app-layout>
    <x-slot name="header">Developer API</x-slot>
            ...
            <div class="bg-[#1e293b] overflow-hidden shadow-xl sm:rounded-lg border border-slate-700">
                <div class="p-6 text-white">
                    ...
                    <div class="bg-slate-800/50 rounded-lg p-6 mb-8 border border-slate-700">
                        ...
                        <div
                            class="flex items-center gap-2 bg-black/30 p-3 rounded border border-slate-600 font-mono text-sm">
                            <span class="text-emerald-400 flex-1">{{ $store->api_key }}</span>
                    ...
                    <div class="prose prose-invert max-w-none">
                        ...
                        <pre class="bg-slate-900 rounded p-4 text-sm font-mono overflow-x-auto">
