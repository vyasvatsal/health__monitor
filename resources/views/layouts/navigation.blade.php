<nav x-data="{ open: false }" class="bg-[#0b1120] border-b border-white/10">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('benchmarks.index')" :active="request()->routeIs('benchmarks.*')">
                        {{ __('Benchmarks') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-300 bg-transparent hover:text-white focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-slate-900 border-b border-white/10">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('benchmarks.index')" :active="request()->routeIs('benchmarks.*')">
                {{ __('Benchmarks') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-white/10">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('settings.alerts')">
                    {{ __('Alert Settings') }}
                </x-responsive-nav-link>
