            ...
            <div x-show="selectedError" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
                    ...
                    <template x-if="selectedError?.ai_analysis">
                        <div class="bg-indigo-500/10 border border-indigo-500/20 rounded-lg p-5 mb-6">
                            ...
                            <div class="space-y-6">
                                <!-- Headline -->
                                <div>
                                    <h4 class="text-xl font-bold text-white mb-2" x-text="selectedError.ai_analysis.title">
                                    </h4>
                                ...
                                <div>
                                    ...
                                    <template x-if="selectedError.ai_analysis.code_fix">
                                        <div
                                            ...
                                            <code class="text-emerald-300 text-xs font-mono break-all whitespace-pre-wrap"
                                ...
                                <!-- Prevention -->
                                <div class="flex gap-3 items-start bg-blue-500/5 p-3 rounded-lg border border-blue-500/10">
                                    ...
                                    <div>
                                        <span class="text-blue-400 text-xs font-bold uppercase block mb-1">Prevention
                                            Tip</span>
                                        <p class="text-slate-300 text-xs" x-text="selectedError.ai_analysis.prevention"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-rose-500/5 border border-rose-500/10 rounded-xl p-5">
                        <h3 class="text-rose-400 text-xs font-bold uppercase tracking-wider mb-2 flex items-center gap-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="bg-[#1e293b] rounded-xl border border-white/5 p-5">
                            ...
                            <div class="flex flex-col gap-3">
                                <div>
                                    <span class="text-slate-500 block text-[10px] uppercase font-semibold mb-1">File</span>
                ...
                <div class="bg-[#0f172a] border border-white/10 rounded-2xl flex flex-col text-white">
                    ...
                    <div class="p-6 space-y-6" x-data="{ tab: 'laravel' }">
                        ...
                        <div x-show="tab === 'laravel'" class="space-y-4">
                            <div class="space-y-2">
                                <h4 class="text-sm font-medium text-white">1. Configure <code>bootstrap/app.php</code></h4>
                                                                ...
                                                                ->withExceptions(function (Exceptions $exceptions) {
                                                                    $exceptions->reportable(function (Throwable $e) {
                                                                        ...
                                                                        \Illuminate\Support\Facades\Http::timeout(2)->post('{{ url('/api/v1/capture') }}', [
                                                                            'store_id' => '{{ $currentStore->id }}', // {{ $currentStore->name }}
                                                                            'type' => get_class($e),
