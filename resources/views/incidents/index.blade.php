                                ...
                                <tbody>
                                    @foreach($incidents as $incident)
                                        <tr
                                            ...
                                            <td
                                                class="px-6 py-5 text-right opacity-100 sm:opacity-0 sm:group-hover/row:opacity-100 transition-opacity">
                                                <div class="flex items-center justify-end gap-2">
                                                    ...
                                                    <form action="{{ route('incidents.destroy', $incident) }}" method="POST"
                                                        ...
                                                        @method('DELETE')
                                                        <button type="submit"
                                                            class="p-2 flex items-center justify-center bg-slate-800/80 hover:bg-red-600 rounded-lg text-slate-400 hover:text-white transition-all border border-white/5 hover:border-red-500 hover:shadow-[0_0_15px_rgba(239,68,68,0.4)]"
