        ...
        <div class="bg-[#1e293b] overflow-hidden shadow-sm rounded-lg border border-white/10">
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('settings.update') }}">
                    @csrf
                    <div class="mb-6">
                        <label for="gemini_api_key_chatbot" class="block text-sm font-medium text-slate-300 mb-2">xAI
                            (Grok) API Key</label>
                        <div class="flex gap-2">
                            <input id="gemini_api_key_chatbot" type="password" name="gemini_api_key_chatbot"
                                ...
                                class="block w-full rounded-lg bg-[#0f172a] border-slate-700 text-white focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm p-2.5 transition-colors"
                                placeholder="gsk_...">
                        </div>
