            ...
            @else
                            ...
                            <div class="p-6 space-y-8">
                                ...
                                <div>
                                    ...
                                    <div class="bg-slate-900 rounded-lg p-4 border border-slate-800">
                                        <code class="text-emerald-400 font-mono text-sm">composer require aihealth/laravel-sdk</code>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-400 mb-3">Add this DSN to your <code class="text-white">.env</code>
                                        file. This instantly enables active tracking for Server Errors, Exceptions, and System Logs.</p>
                ...
                Schedule::command('aihealth:send-health')->everyFiveMinutes();</code></pre>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-3 pt-3 border-t border-slate-700/50"><strong>Bonus:</strong> To
