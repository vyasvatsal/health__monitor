                ...
                return {
                    ...
                    get filteredErrors() {
                        return this.errors.filter(error => {
                            ...
                            const safeType = error.type || '';
                            const safeFile = error.file || '';

                            const matchesSearch = safeMessage.toLowerCase().includes(searchLower) ||
                                safeType.toLowerCase().includes(searchLower) ||
                                safeFile.toLowerCase().includes(searchLower);
