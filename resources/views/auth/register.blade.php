...
<head>
    ...
    <title>Register | AI Store Health Monitor</title>
    <!-- Fonts -->
...
<body class="antialiased min-h-screen flex items-center justify-center p-4 relative overflow-hidden text-slate-300">
    ...
    <div
        ...
        <h2 class="text-2xl font-bold text-white mb-2 text-center">Create your account</h2>
        <p class="text-slate-500 text-center text-sm mb-6">Start your 14-day free trial. No credit card required.</p>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <!-- Name -->
            <div>
                <label for="name" class="block text-sm font-medium text-slate-400 mb-1">Full Name</label>
            ...
            <!-- Confirm Password -->
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-slate-400 mb-1">Confirm
                    Password</label>
        ...
        <div class="mt-6 text-center text-sm text-slate-500">
            ...
            <a href="{{ route('login') }}" class="text-emerald-400 hover:text-emerald-300 font-medium transition">Log
                in</a>
        </div>
    </div>
</body>
